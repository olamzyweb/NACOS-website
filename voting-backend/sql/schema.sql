...
VALUES
  ...
  ('fashion-icon-of-the-year', 'Fashion Icon of the Year', 'Consistent, unique, and trend-setting fashion sense.', 'social-personality', 'Social & Personality', 3, '#cc4d7c', '/awards_gala_night_bg_1778965666277.png', 100, 17),
